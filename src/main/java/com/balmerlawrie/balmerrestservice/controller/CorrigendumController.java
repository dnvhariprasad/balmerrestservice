...
public class CorrigendumController {
    ...
    public ResponseEntity<JsonNode> getOriginalNotesheet(
        ...
        JsonNode result = noteSheetService.getOriginalNotesheet(processInstanceId, workitemId, sessionId, CORRIGENDUM_ORIGINAL_ATTRIBUTE);
    ...
    public ResponseEntity<JsonNode> createPdfNote(
        ...
        JsonNode result = noteSheetService.createCorrigendumPdfNote(processInstanceId, workitemId, sessionId);

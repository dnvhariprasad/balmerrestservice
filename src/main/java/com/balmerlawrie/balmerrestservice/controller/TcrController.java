...
public class TcrController {
    ...
    public ResponseEntity<JsonNode> getOriginalNotesheet(
        ...
        JsonNode result = noteSheetService.getOriginalNotesheet(processInstanceId, workitemId, sessionId, TCR_ORIGINAL_ATTRIBUTE);
    ...
    public ResponseEntity<JsonNode> createPdfNote(
        ...
        JsonNode result = noteSheetService.createTcrPdfNote(processInstanceId, workitemId, sessionId);

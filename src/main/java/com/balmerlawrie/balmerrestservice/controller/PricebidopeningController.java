...
public class PricebidopeningController {
    ...
    public ResponseEntity<JsonNode> getOriginalNotesheet(
        ...
        JsonNode result = noteSheetService.getOriginalNotesheet(processInstanceId, workitemId, sessionId, PRICEBID_ORIGINAL_ATTRIBUTE);
    ...
    public ResponseEntity<JsonNode> createPdfNote(
        ...
        JsonNode result = noteSheetService.createPricebidopeningPdfNote(processInstanceId, workitemId, sessionId);
